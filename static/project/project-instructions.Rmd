...
due_date <- c("Week 6 - end of class on Friday (6th September)",
              "Week 7 - end of class on Friday (13th September)", 
              "Week 9 - end of class on Friday (27th September)", 
              "Week 11 - end of class on Friday (11th October)", 
              "Week 12 - Wednesday and Friday (16th and 18th October)")

turn_in <- c("Prospective team members and topics",
             "Team members and team name, and paragraph de- scribing possible data sets, with links to the data sources.",
             "Electronic copy of your data, and a page of data de- scription, and cleaning done, or needing to be done.",
             "Final version of story board uploaded",
             "Project presentations during class periods. All stu- dents are expected to attend, and points will be de- ducted for non-attendance.")
