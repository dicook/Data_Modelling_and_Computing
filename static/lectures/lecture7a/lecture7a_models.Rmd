...
mod1 <- lm(science~log_science_time+science_fun_c, data=pisa_au_science)
mod2 <- lm(science~log_science_time*science_fun_c, data=pisa_au_science)
tidy(mod1)
tidy(mod2)
```
...
- Strongly disagree: $447.49+2.75 x_1$
- Disagree: $447.49-118.44+(2.75+64.90)x_1=329.05+67.65x_1$
- Agree: $447.49-195.57+(2.75+110.93)\times x_1=251.92+113.68x_1$
- Strongly agree: $447.49-111.96+(2.75+94.12)\times x_1=335.53+96.87x_1$
...
2. $251.92+113.68log10(360)=542.5$
