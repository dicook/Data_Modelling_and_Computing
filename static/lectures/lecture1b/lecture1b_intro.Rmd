...
- These lecture notes are created using R Markdown, flexdashboard output.
...
*Note on ethics:* When you use someone else's work, you need to (1) check if its allowed, that it has a [creative commons license](http://creativecommons.org/licenses/by/4.0/), (2) reference them as the source.
...
We are pull to take data from the Atlas of Living Australia, and write a short report on Platypus sightings. Install the package `ALA4R` and load it.
