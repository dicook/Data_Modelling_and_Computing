...
1. Use the `cricketdata` package to extract *batting* data of male players for your two favorite countries.
...
5. Web scrape the ODI and T20 ratings for men's cricekt teams, from https://www.icc-cricket.com/rankings/mens/team-rankings . Make a plot of the ODI vs T20 rating. What countries do better in T20 relative to their ODI performance?
