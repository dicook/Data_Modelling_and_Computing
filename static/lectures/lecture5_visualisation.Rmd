...
score_gap <- countries %>% 
  group_by(Name) %>%
  summarise(wmath_m = weighted.mean(PV1MATH[ST004D01T=="male"],
                       w=SENWT[ST004D01T=="male"], na.rm=T),
            wmath_f = weighted.mean(PV1MATH[ST004D01T=="female"],
                       w=SENWT[ST004D01T=="female"], na.rm=T),
            wread_m = weighted.mean(PV1READ[ST004D01T=="male"],
                       w=SENWT[ST004D01T=="male"], na.rm=T),
            wmread_f = weighted.mean(PV1READ[ST004D01T=="female"],
                       w=SENWT[ST004D01T=="female"], na.rm=T),
            wscience_m = weighted.mean(PV1SCIE[ST004D01T=="male"],
                       w=SENWT[ST004D01T=="male"], na.rm=T),
            wscience_f = weighted.mean(PV1SCIE[ST004D01T=="female"],
                       w=SENWT[ST004D01T=="female"], na.rm=T),
            wmathgap=weighted.mean(PV1MATH[ST004D01T=="male"],
                       w=SENWT[ST004D01T=="male"], na.rm=T)-
