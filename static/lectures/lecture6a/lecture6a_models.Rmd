...
- Try to add a quadratic term (in day0) to the model to improve the fit. 
...
- Formula
    ...
    - e.g. `y ~ x1+x2+x3` three explantory variables to be used to model response, main effects only
