...
.huge[
* Graduated with a Bachelor of Economics and Bachelor of Commerce from Monash
* and studying a Masters of Statistics at QUT, based at Monash.  
* loves to read `r emo::ji("book")`, any and all recommendations are welcome. 
* Has an R package called taipan, and another called sugarbag soon to appear. 
]
...
.huge[
* A data science exploreR, graduated from Monash University studying Econometrics, Math Statistics & Computational Science. 
...
* Masters and Honors in Statistics back in India, where she also worked as a consultant and senior analyst in firms like KPMG and American Express.  
...
.huge[
* Commerce bachelor in 2018 & doing Honours in Econometrics this year. 
* loves puzzles games like jigsaws `r emo::ji("jigsaw")`. 
* Doing honours thesis with Di Cook and is on the way to have her first ever package, whose name is still a mystery `r emo::ji("thinking")`.
]
...
```{r grover, out.width = "55%", echo = FALSE}
...
.huge[
* __Free__
* __Powerful__: Over 15000 contributed packages on the main repository (CRAN), as of Feb 2019, provided by top international researchers and programmers. 
...
.huge[
- If you feel like your performance in the class is being impacted by your experiences outside of class, please don't hesitate to come and talk with me. I want to be a resource for you. If you prefer to speak with someone outside of the course, talk to . 
...
*Fun fact:* [Hadley Wickham](http://hadley.nz/), the author and maintainer of these packages (along with a team of developers), was a student of the creator of the course, Professor Di Cook.
...
*NOTE: Reading assignment on web site due before Thursday's class*
...
- `r emo::ji("airplane")` R latest version: [Install this first](https://cloud.r-project.org/) because it is what does the work
...
There are more than 15000 packages available on the main archive contributed by experts (and relatively new to R people too). There are another several hundred on the bioconductor archive, focused primarily on bioinformatics applications. There are many more on people's github pages, that may be in development.
