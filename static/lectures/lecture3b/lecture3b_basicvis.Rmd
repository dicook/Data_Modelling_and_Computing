...
+ Months have differeing numbers of days.
...
What happens if you try to specify the tiimzone with `AEST`?
...
A lst of acceptable time zones can be found at https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
...
Pull the 2017 data for the sensor Birrarung Marr. Make plots to answer these questions. 
    a. Is there the same daily pattern as observed at Melbourne Central? If not, how does it differ?
    b. Can you detect special events, like the Australian Open tennis, based on pedestrian counts?  What dates does it appear that there were events on? Can you match these with known events, found from web searching?
