...
- It helps to create directories underneath this to help organise different parts, and make it easier to share your work with others, for e.g. creating and using a `data` folder in the project folder allows relative file referencing like `tb <- read_csv("data/tb.csv")`
which will work across any computer platform.
- When you exit RStudio after finishing your work, it is a good idea to choose "Don't save" your workspace. Hopefully everything that you do can be easily reproduced. Not storing the objects you have created helps to avoid conflicts down the road.
