...
Why do we focus so much on fitting a single best model? Why not fit multiple models. Different models might reveal different information from the data.
...
The code below will help you read in the data and process it.
