...
- Print out the model coefficients table. 
- Based on the parametric approach, which variables are important for predicting science score.
...
pisa_au_science <- pisa_au %>% 
  ...
  select(science, science_fun, science_time, gender, anxtest) %>%
...
sci_lm <- lm(science ~ science_fun_c + science_time + gender*anxtest, data=pisa_au_science)
tidy(sci_lm)
```
