...
This type of display isa called a "heatmap", displays the data table, with cells coloured according to some other information. In this case it is type of variable, and missingness status. What do we learn?
...
Overall statistics, 3% of possible values are missing. That's not much. BUT, bot air temperature and humidity have more than 10% missing which is too much to ignore.
