...
The first 9 rows are general information about the data, not actual data. There are 10 rows of data, containing categories of education. The 10th row contains the summ of the other rows. We could drop this and re-calculate totals on the fly. 
...
The same code from question 1 is repeated. We add a new columnm called year (2006, 2011, 2016), and bind the rows together.
