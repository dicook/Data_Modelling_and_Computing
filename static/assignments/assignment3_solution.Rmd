...
2. Read in the raw data and put it into tidy form. The code is provided, with a few spots where you need to fill in the functions. Where you see `???` in the code, is where you need to fill in to make it work.
