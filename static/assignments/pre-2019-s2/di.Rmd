---
title: "The Diana Household Electricity Use"
author: "ETC1010"
date: "`r Sys.Date()`"
output:
...
```{marginfigure}
Typically more energy use over the weekends, and Tuesday/Thursday during the week. These latter two days, especially Thursday is usually a work from home day.
```
...
```{marginfigure}
There is a strong work day vs weekend pattern. The week day typically has less usage in the middle of the day. Weekend has relatively constant usage. Both types of days though often start around 5am, and end around 9-10pm. 
```
...
```{marginfigure}
The weekend vs week day pattern is visible, and the evening peak usage most days. Looks like you were travelling in December. Some air conditioning use in summer, and heating in June and July.
```
