...
```{r CO2-map, fig.width=4.5, fig.height=2.5, warning=FALSE, message=FALSE, echo=FALSE, cache=FALSE}
...
- CO$_2$ is increasing, and it looks like it is exponential increase. 
