...
- Week 6: Introduction to modeling
    - [Wed](https://ebsmonash.shinyapps.io/lecture6a_models) [(Rmd)](http://dmac.dicook.org/lectures/lecture6a/lecture6a_models.Rmd)
...
- Assignment 2: [Instructions](assignments/assignment2.html) [(Rmd)](assignments/assignment2.Rmd) [SOLUTION](assignments/assignment2_solution.html) [(Rmd)](assignments/assignment2_solution.Rmd); [Example data](assignments/data/meter1.csv) **DUE: Week 4, individual on Wed, group Fri, during class**
- Assignment 3: [Instructions](assignments/assignment3.html) [(Rmd)](assignments/assignment3.Rmd) [oz_weather.csv](assignments/data/oz_weather.csv) [stns_oz.csv](assignments/data/stns_oz.csv) **DUE: Week 6, individual on Wed, group Fri, at the start of class**
- Assignment 4:
- Assignment 5:
