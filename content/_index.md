...
- Week 2: Tidy data principles, reshaping your data into tidy form, and basic data wrangling
    - [Tue](https://ebsmonash.shinyapps.io/lecture2a_tidydata/) [(Rmd)](http://dmac.dicook.org/lectures/lecture2a/lecture2a_intro.Rmd));  [Reading Textbook 5.1, 5.2, 5.3, 5.4, 5.5, 5.6 *only the first paragraph of each section!*](http://r4ds.had.co.nz/transform.html)
