...
- Week 1: Getting yourself setup to do reproducible analyses, and introduction to the language of data analysis (the R ecosystem)
    - [Tue]() [(Rmd)](); [Reading Textbook 27.1-5](http://r4ds.had.co.nz/r-markdown.html) Go to ED and complete the reading quiz before Friday's class
    - [Thu]() [(Rmd)]()); [Reading Textbook 12.1-4](http://r4ds.had.co.nz/tidy-data.html) Go to ED and complete the reading quiz before Tuesday's class
- Week 2: Tidy data principles, reshaping your data into tidy form, and basic data wrangling
    ...
    - [Thu]() [(Rmd)]() [Reading Text book 3.1-3.3](http://r4ds.had.co.nz/data-visualisation.html)
